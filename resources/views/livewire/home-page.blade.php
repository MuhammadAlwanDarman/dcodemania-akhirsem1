<div>
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">Alwaan Store</span></h1>
    ...
    <section class="py-20">
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            ...
            @foreach ($brands as $b)
                ...
                <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $b->id }}">
                    <a href="/products?selected_brands[0]={{ $b->id}}" class="">
    ...
    <div class="bg-slate-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-700"> Browse <span class="text-blue-500"> Categories
                        </span> </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                        </div>
        ...
        <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            @foreach ($categories as $c)
                ...
                <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="/products?selected_categories[0]={{ $c->id}}" wire:ket="{{ $c->id }}">
