                ...
                <div class="flex flex-wrap mb-24 -mx-3">
                            ...
                            <ul>
                                @foreach ($brands as $b)
                                    ...
                                    <li class="mb-4" wire:key="{{ $b->id }}">
                                        <label for="{{ $b->slug }}" class="flex items-center dark:text-gray-400 ">
                            ...
                            <ul>
                                ...
                                <li class="mb-4">
                                    <label for="on_sale" class="flex items-center dark:text-gray-300">
                                        <input type="checkbox" class="w-4 h-4 mr-2" wire:model.live="on_sale" value="2">
                    ...
                    <div class="w-full px-3 lg:w-3/4">
                        <div class="px-3 mb-4">
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    <select name="" id="" wive:model.live="sort "
                        ...
                        @foreach ($products as $p)
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:kkey="{{ $p->id }}">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    <div class="relative bg-gray-200">
                                        <a href="/products/{{ $p->slug }}" class="">
                                            <img src="{{ url('storage', $p->images[0]) }}"
                                    ...
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        ...
                                        <a href="#" wire:click.prevent="addToCart({{ $p->id }})"
                                            ...
                                            </svg><span wire:loading.remove>Add to Cart</span><span wire:loading wire:target="addToCart({{ $p->id }})">Adding...</span>
                                        </a>
